...
// -----------------------------------------------------------------------------
	...
	public function __construct($code) {
		...
		// get minisnum required matrix size.
	...
	/**
	 * Choose the minisnum matrix size and return the max number of data codewords.
	...
	/**
	 * Get high level encoding using the minisnum symbol data characters for ECC 200
	 * @param $data (string) data to encode
